...
public class PathUtil {
	...
	/**
	 * request url
	 * http://localhost:8080/galaxy/list?pageNo=1(galaxy is project's name)
	 * 
	 **/
	...
	/**
	 * 获取项目及请求路径
	 * @return String http://localhost:8080/galaxy/list
	 */
	...
	/**
	 * 获取class编译根目录
	 * @return String ...\webapps\galaxy-example\WEB-INF\classes
	 */
	...
	/**
	 * 获取项目的根目录的绝对路径
	 * @return String ...\webapps\galaxy-example
	 */
